...
import { TeamProjectsSheet } from "./team-projects-sheet";

export interface TeamProjectsRow {
  _id?: number;
  teamName: string;
  projectName: string;
  description: string;
...
export const columns: ColumnDef<TeamProjectsRow>[] = [
  {
